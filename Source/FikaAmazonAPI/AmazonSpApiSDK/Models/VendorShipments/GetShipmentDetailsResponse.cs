...
{
	public class GetShipmentDetailsResponse : IEquatable<GetShipmentDetailsResponse>, IValidatableObject
	{
		/// <summary>
		...
		public GetShipmentDetailsResponse(ShipmentDetails payload = default(ShipmentDetails), ErrorList errors = default(ErrorList))
		{
		...
		{
			this.Payload = default(ShipmentDetails);
		...
		public ShipmentDetails Payload { get; set; }
