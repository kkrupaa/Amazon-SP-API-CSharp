...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    public partial class RemovalShipmentAdjustmentEvent : IEquatable<RemovalShipmentAdjustmentEvent>, IValidatableObject
    {
        ...
        public RemovalShipmentAdjustmentEvent(string AdjustmentType = default(string), DateTime? PostedDate = default(DateTime?), Currency AdjustmentAmount = default(Currency), AdjustmentItemList AdjustmentItemList = default(AdjustmentItemList))
        {
