...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    public partial class FailedAdhocDisbursementEvent : IEquatable<FailedAdhocDisbursementEvent>, IValidatableObject
    {
        ...
        public FailedAdhocDisbursementEvent(string AdjustmentType = default(string), DateTime? PostedDate = default(DateTime?), Currency AdjustmentAmount = default(Currency), AdjustmentItemList AdjustmentItemList = default(AdjustmentItemList))
        {
        ...
        /// <summary>
        /// Returns true if FailedAdhocDisbursementEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of FailedAdhocDisbursementEvent to be compared</param>
        /// <returns>Boolean</returns>
