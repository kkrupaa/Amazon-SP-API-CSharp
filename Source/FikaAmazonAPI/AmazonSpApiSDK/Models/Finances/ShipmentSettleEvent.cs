...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentSettleEvent : IEquatable<ShipmentSettleEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentSettleEvent" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentSettleEvent {\n");
        ...
        {
            return this.Equals(input as ShipmentSettleEvent);
        }

        /// <summary>
        /// Returns true if ShipmentSettleEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentSettleEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentSettleEvent input)
        {
            if (input == null)
                return false;
