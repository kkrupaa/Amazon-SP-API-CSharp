...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    public partial class ValueAddedServiceChargeEvent : IEquatable<ValueAddedServiceChargeEvent>, IValidatableObject
    {
        ...
        public ValueAddedServiceChargeEvent(string transactionType = default(string), DateTime? postedDate = default(DateTime?), string description = default(string), Currency transactionAmount = default(Currency))
        {
