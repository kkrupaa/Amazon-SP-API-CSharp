...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public partial class FailedAdhocDisbursementEventList : List<FailedAdhocDisbursementEvent>, IEquatable<FailedAdhocDisbursementEventList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FailedAdhocDisbursementEventList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FailedAdhocDisbursementEventList input)
        {
            if (input == null)
                return false;
