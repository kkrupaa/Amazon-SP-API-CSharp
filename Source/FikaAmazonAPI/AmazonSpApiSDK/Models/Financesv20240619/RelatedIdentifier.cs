...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances.Model
{
    ...
    public partial class RelatedIdentifier :  IEquatable<RelatedIdentifier>, IValidatableObject
    {
        ...
        public enum RelatedIdentifierNameEnum
        {
            ...
            [EnumMember(Value = "ADJUSTMENT_EVENT_ID")]
            ADJUSTMENTEVENTID = 12,
            
            [EnumMember(Value = "SELLER_REMOVAL_ORDER_ID")]
            SELLERREMOVALORDERID = 13,

            /// <summary>
            /// Enum SAFETCLAIMID for value: SAFET_CLAIM_ID (undocumented but returned by API)
            /// </summary>
            [EnumMember(Value = "SAFET_CLAIM_ID")]
            SAFETCLAIMID = 14,

            /// <summary>
            /// Enum OBFUSCATEDSHIPMENTID for value: OBFUSCATED_SHIPMENT_ID (undocumented but returned by API)
            /// </summary>
            [EnumMember(Value = "OBFUSCATED_SHIPMENT_ID")]
            OBFUSCATEDSHIPMENTID = 15
        }
