...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances.Model
{
    ...
    public partial class Context : IEquatable<Context>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="contextType">The type of context. Possible values: ProductContext, AmazonPayContext, PaymentsContext, DeferredContext, BusinessContext, TimeRangeContext.</param>
        ...
        public Context(string contextType = default(string), string storeName = default(string), string orderType = default(string), string channel = default(string), string asin = default(string), string sku = default(string), int? quantityShipped = default(int?), string fulfillmentNetwork = default(string), string paymentType = default(string), string paymentMethod = default(string), string paymentReference = default(string), DateTime? paymentDate = default(DateTime?), string deferralReason = default(string), DateTime? maturityDate = default(DateTime?), DateTime? startTime = default(DateTime?), DateTime? endTime = default(DateTime?))
        {
        ...
        /// <summary>
        /// The type of context. Possible values: ProductContext, AmazonPayContext, PaymentsContext, DeferredContext, BusinessContext, TimeRangeContext.
        /// </summary>
        ...
        /// </summary>
        /// <value>The deferral policy applied to the transaction.</value>
