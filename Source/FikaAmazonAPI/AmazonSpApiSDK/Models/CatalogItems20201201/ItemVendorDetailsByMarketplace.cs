...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems20201201
{
    ...
    public partial class ItemVendorDetailsByMarketplace :  IEquatable<ItemVendorDetailsByMarketplace>, IValidatableObject
    {
        ...
        /// <param name="categoryCode">Product category associated with an Amazon catalog item..</param>
        ...
        /// <param name="subcategoryCode">Product subcategory associated with an Amazon catalog item..</param>
        public ItemVendorDetailsByMarketplace(string marketplaceId = default(string), string brandCode = default(string), string categoryCode = default(string), string manufacturerCode = default(string), string manufacturerCodeParent = default(string), string productGroup = default(string), ReplenishmentCategoryEnum? replenishmentCategory = default(ReplenishmentCategoryEnum?), string subcategoryCode = default(string))
        {
