...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems20201201
{
    ...
    public partial class ItemSearchResults :  IEquatable<ItemSearchResults>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ItemSearchResults" /> class.
        /// </summary>
        /// <param name="numberOfResults">The estimated total number of products matched by the search query (only results up to the page count limit will be returned per request regardless of the number found).  Note: The maximum number of items (ASINs) that can be returned and paged through is 1000. (required).</param>
        ...
        /// </summary>
        /// <value>The estimated total number of products matched by the search query (only results up to the page count limit will be returned per request regardless of the number found).  Note: The maximum number of items (ASINs) that can be returned and paged through is 1000.</value>
