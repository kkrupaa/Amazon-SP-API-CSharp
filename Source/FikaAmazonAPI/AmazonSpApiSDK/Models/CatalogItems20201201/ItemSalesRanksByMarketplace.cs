...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems20201201
{
    ...
    public partial class ItemSalesRanksByMarketplace :  IEquatable<ItemSalesRanksByMarketplace>, IValidatableObject
    {
        ...
        /// <param name="ranks">Sales ranks of an Amazon catalog item for an Amazon marketplace. (required).</param>
        public ItemSalesRanksByMarketplace(string marketplaceId = default(string), List<ItemSalesRank> ranks = default(List<ItemSalesRank>))
        {
            ...
            if (ranks == null)
            {
                throw new InvalidDataException("ranks is a required property for ItemSalesRanksByMarketplace and cannot be null");
            }
            else
            {
                this.Ranks = ranks;
        ...
        /// </summary>
        /// <value>Sales ranks of an Amazon catalog item for an Amazon marketplace.</value>
        [DataMember(Name="ranks", EmitDefaultValue=false)]
        public List<ItemSalesRank> Ranks { get; set; }
